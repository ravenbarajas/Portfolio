...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ["ReactJS", "TypeScript", "FastAPI", "ExpressJS", "PostgreSQL"],
    ...
    // Technology tags to be updated //
    {
      ...
      technologies: ["ReactJS", "TypeScript", "ExpressJS"],
    ...
    },
    {
      ...
      technologies: ["Python", "OpenAI GPT-3", "FastAPI", "Streamlit"],
      category: "AI/ML",
    ...
    },
    {
      ...
      technologies: ["ReactJS", "TypeScript", "ExpressJS", "MongoDB"],
      category: "Web Apps",
    ...
    },
    {
      ...
      technologies: ["Python", "OpenAI API", "FastAPI", "Streamlit"],
      category: "AI/ML",
