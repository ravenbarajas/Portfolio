...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      details: "Offers customizable visualizations for tracking key performance indicators, analyzing trends, and gaining actionable insights across various business processes, vendor contracts, and financial data. Supports data integration from multiple sources to facilitate informed decision-making.",
