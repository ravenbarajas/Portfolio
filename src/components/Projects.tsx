...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      details: "An AI-powered platform designed to automate guest interactions and services, leveraging OpenAI API and LangChain to provide intelligent responses.",
    ...
    },
    {
      ...
      details: "A centralized administration suite for managing multiple properties, offering comprehensive tools for property management, and tenant relations.",
